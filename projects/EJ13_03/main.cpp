...
void render(const Geometry& quad, const Geometry& cube, const Shader& s_phong, const Shader& s_fbo,
    ...
    s_fbo.set("textureSize", glm::vec2(static_cast<float>(Window::instance()->getHeight()), static_cast<float>(Window::instance()->getWidth())));
    //s_fbo.set("textureSize", glm::vec2(1000,1000));
    s_fbo.set("sigma", 0.1f);//Cantidad de Blur
