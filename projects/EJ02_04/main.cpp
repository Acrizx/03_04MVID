...
uint32_t createProgram() {
	...
	const char* fragmentShaderSource = "#version 330 core\n"
		"out vec4 FragColor;\n"
		"in vec4 colorElement;"
		"void main() {\n"
		"    FragColor = colorElement;\n"
		"}\0";
...
uint32_t createVertexData(uint32_t* VBO, uint32_t* EBO) {
	float vertices[] = {
		-1.0f, -0.5f, 0.0f,1, 0, 0,1.0f,
		-0.5f, 0.5f, 0.0f,1, 0, 0,1.0f,
		0.0f, -0.5f, 0.0f,1, 0, 0,1.0f,
		0.0f, -0.5f, 0.0f,0, 0, 1,1.0f,
		0.5f, 0.5f, 0.0f,0, 0, 1,1.0f,
		1.0f, -0.5f, 0.0f,0, 0, 1,0.0f,
	};
