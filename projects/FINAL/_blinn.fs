...
vec3 calcSpotLight(SpotLight light, vec3 normal, vec3 viewDir, vec3 fragPos, vec3 albedoMap, vec4 fragPosLighSpace) {
...
void main() {
    ...
    //    if(i == 0){
    //        finalColor += calcSpotLight(spotLight[i], norm, viewDir, fragPos, albedo, fragPosLighSpace);
    //    }
    //    else{
    //        finalColor += calcSpotLight(spotLight[i], norm, viewDir, fragPos, albedo, fragPosLighSpace2);
    //    }
    //}
