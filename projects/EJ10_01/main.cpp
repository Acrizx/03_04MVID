...
void render(const Model& object, const Shader& s_phong, const Shader& s_light) {
...
int main(int, char* []) {
    ...
    const Model object("../assets/models/Statue/Statuette.obj");
    int u = object.textures_loaded_.size();
